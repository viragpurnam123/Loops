...
public class InternalLoopsDslLexer extends Lexer {
    ...
    public final void mRULE_EXPRESSION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:405:17: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\"' | '(' | ')' | '.' | ',' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '\"' | '(' | ')' | '.' | ',' )* )
            // InternalLoopsDsl.g:405:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\"' | '(' | ')' | '.' | ',' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '\"' | '(' | ')' | '.' | ',' )*
            {
            ...
            // InternalLoopsDsl.g:405:63: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '\"' | '(' | ')' | '.' | ',' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:407:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalLoopsDsl.g:407:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalLoopsDsl.g:407:11: ( '^' )?
            int alt2=2;
            ...
            // InternalLoopsDsl.g:407:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:409:10: ( ( '0' .. '9' )+ )
            // InternalLoopsDsl.g:409:12: ( '0' .. '9' )+
            {
            // InternalLoopsDsl.g:409:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:411:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalLoopsDsl.g:411:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalLoopsDsl.g:411:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalLoopsDsl.g:411:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalLoopsDsl.g:411:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalLoopsDsl.g:411:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalLoopsDsl.g:411:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:413:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalLoopsDsl.g:413:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalLoopsDsl.g:413:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:415:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalLoopsDsl.g:415:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalLoopsDsl.g:415:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:417:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalLoopsDsl.g:417:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalLoopsDsl.g:417:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLoopsDsl.g:419:16: ( . )
            // InternalLoopsDsl.g:419:18: .
            {
            matchAny(); 
